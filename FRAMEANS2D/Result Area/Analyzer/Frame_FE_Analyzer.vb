Imports System.Math
Public Class Frame_FE_Analyzer
...
#Region " Fixed End Reaction - Force & Moment"
        ...
        Private Function deltaI_UVLoadCase2(ByVal W As Double, ByVal a As Double, ByVal c As Double, ByVal L As Double) As Double
            ...
            gamma = c / L
            Di = ((W * (L ^ 3) * gamma) *
                 ((270 * (alpha - (alpha ^ 3))) - ((gamma ^ 2) * ((45 * alpha) - (2 * gamma))))) /
                 (3240)
            Return Di
        End Function
        ...
        Private Function deltaJ_UVLoadCase2(ByVal W As Double, ByVal b As Double, ByVal c As Double, ByVal L As Double) As Double
            ...
            gamma = c / L
            Dj = ((W * (L ^ 3) * gamma) *
                 ((270 * (beta - (beta ^ 3))) - ((gamma ^ 2) * ((45 * beta) + (2 * gamma))))) /
                 (3240)
            Return Dj
        End Function
            ...
            For Each UL In ElDetails.Uload
                ...
                If intensity1 <= intensity2 Then
                    ...
                    ElseIf ((_curDx >= UL.ulocation1) And (_curDx < UL.ulocation2)) Then
                        ...
                        _SecF = ((intensity2 - intensity1) / (UL.ulocation2 - UL.ulocation1)) *
...
#Region "Bending Moment Calculation"
        Private Function Total_BendingMoment_L(ByVal _curDx As Double) As Double
            ...
            Dim BM As Double
            BM = BM_EndMoment_L(_curDx) +
                 BM_EndReaction_L(_curDx) +
                 BM_PointLoad_L(_curDx) +
                 BM_UVL_L(_curDx) +
                 BM_moment_L(_curDx)
            Return BM
        End Function
            ...
            For Each UL In ElDetails.Uload
                ...
                If intensity1 <= intensity2 Then
                    If (_curDx > UL.ulocation2) Then
                        _RectF = intensity1 * (UL.ulocation2 - UL.ulocation1)
                        _TriF = 0.5 * (intensity2 - intensity1) * (UL.ulocation2 - UL.ulocation1)
                        BM = (_RectF * (_curDx - (UL.ulocation1 + ((UL.ulocation2 - UL.ulocation1) * 0.5)))) +
                    ...
                    ElseIf ((_curDx >= UL.ulocation1) And (_curDx <= UL.ulocation2)) Then
                        ...
                        _SecF = ((intensity2 - intensity1) / (UL.ulocation2 - UL.ulocation1)) *
                                (_curDx - UL.ulocation1)
                        _TriF = 0.5 * _SecF * (_curDx - UL.ulocation1)
                        BM = (_RectF * (((_curDx - UL.ulocation1) * 0.5))) +
...
#End Region
        ...
        Public Sub SetCoordinates()
            ...
            Dim _origin As Point = New Point((ElDetails.SN.Coord.X + ElDetails.EN.Coord.X) / 2,
            ...
            _ResulCoords._MemPoints.Add(
                        New Point(
                            (_origin.X) + (-(_scaledLength / 2) * Math.Cos(_incl) - 0 * Math.Sin(_incl)),
                            (_origin.Y) + (-(_scaledLength / 2) * Math.Sin(_incl) + 0 * Math.Cos(_incl))))
            For i = -(_scaledLength / 2) To (_scaledLength / 2) Step _dx
                _ResulCoords._MemPoints.Add(
                        New Point(
                            (_origin.X) + (i * Math.Cos(_incl) - 0 * Math.Sin(_incl)),
            ...
            If LoadScale(0) <> 0 Then
                IndexV = 0
                _ResulCoords._SFPoints.Add(
                            New Point(
                                (_origin.X) + (-(_scaledLength / 2) * Math.Cos(_incl) - (0 * (ResultDispMax / LoadScale(0)) * Math.Sin(_incl))),
                ...
                For i = -((_scaledLength / 2)) To ((_scaledLength / 2)) Step _dx
                    ...
                    _ResulCoords._SFPoints.Add(
                            New Point(
                                (_origin.X) + (i * Math.Cos(_incl) - (_ResulCoords.shearValues(IndexV) * (ResultDispMax / LoadScale(0)) * Math.Sin(_incl))),
            ...
            If LoadScale(1) <> 0 Then
                IndexV = 0
                _ResulCoords._BMPoints.Add(
                            New Point(
                                (_origin.X) + (-(_scaledLength / 2) * Math.Cos(_incl) - (0 * (ResultDispMax / LoadScale(1)) * Math.Sin(_incl))),
                ...
                For i = -(_scaledLength / 2) To ((_scaledLength / 2)) Step _dx
                    ...
                    _ResulCoords._BMPoints.Add(
                            New Point(
                                (_origin.X) + ((i * Math.Cos(_incl)) - (_ResulCoords.bendingValues(IndexV) * (ResultDispMax / LoadScale(1)) * Math.Sin(_incl))),
            ...
            If LoadScale(2) <> 0 Then
                ...
                For i = -(_scaledLength / 2) To ((_scaledLength / 2)) Step _dx
                    ...
                    _ResulCoords._DEPoints.Add(
                            New Point(
                                (_origin.X) + ((i + (_ResulCoords.deflectionValuesX(IndexV) * (ResultDispMax / LoadScale(2)))) * Math.Cos(_incl) - (_ResulCoords.deflectionValuesY(IndexV) * (ResultDispMax / LoadScale(2)) * Math.Sin(_incl))),
            ...
            If LoadScale(3) <> 0 Then
                IndexV = 0
                _ResulCoords._AXPoints.Add(
                                       New Point(
                                           (_origin.X) + (-(_scaledLength / 2) * Math.Cos(_incl) - (0 * (ResultDispMax / LoadScale(3)) * Math.Sin(_incl))),
                ...
                For i = -(_scaledLength / 2) To ((_scaledLength / 2)) Step _dx
                    ...
                    _ResulCoords._AXPoints.Add(
                            New Point(
                                (_origin.X) + (i * Math.Cos(_incl) - (_ResulCoords.axialForcevalues(IndexV) * (ResultDispMax / LoadScale(3)) * Math.Sin(_incl))),
...
#End Region
    ...
    Public Sub New(Optional ByVal Tcpass As Boolean = False)
        ...
        _updateStr = "------------- Finite Element Analyzer ----------------" & vbNewLine &
                    ...
                    "------------------------------------------------------" & vbNewLine &
                    "--- The horse is made ready for the day of battle, but victory" & vbNewLine &
                    "--- rests with the LORD <Proverb 21:31>" & vbNewLine &
                    "--- Unless the LORD builds the house, its builders labor in vain. Unless the" & vbNewLine &
                    "--- LORD watches over the city, the watchmen stand guard in vain. <Psalm 127:1>" & vbNewLine &
                    vbNewLine &
                    vbNewLine
    ...
    Private Sub CorrectNodeSupportError()
            ...
            For Each ReO In Rc.ReOccurMember
                If WA2dt.Mem(ReO).SN.index = WA2dt.Bob(Rc.NdNumber).index Then
                    If WA2dt.Mem(ReO).SN.Support.PS = True Or
                        WA2dt.Mem(ReO).SN.Support.PRS = True Or
                        WA2dt.Mem(ReO).SN.Support.FRS = True Or
                        WA2dt.Mem(ReO).SN.Support.FS = True Or
                        WA2dt.Mem(ReO).SN.Support.SS = True Then
                        SupportRevised = New _
                                    Line2DT.Node.SupportCondition(False,
                                                False,
                                                WA2dt.Mem(ReO).SN.Support.PS,
                                                WA2dt.Mem(ReO).SN.Support.PRS,
                                                WA2dt.Mem(ReO).SN.Support.FRS,
                                                WA2dt.Mem(ReO).SN.Support.FS,
                                                WA2dt.Mem(ReO).SN.Support.SS,
                ...
                ElseIf WA2dt.Mem(ReO).EN.index = WA2dt.Bob(Rc.NdNumber).index Then
                    If WA2dt.Mem(ReO).EN.Support.PS = True Or
                        WA2dt.Mem(ReO).EN.Support.PRS = True Or
                        WA2dt.Mem(ReO).EN.Support.FRS = True Or
                        WA2dt.Mem(ReO).EN.Support.FS = True Or
                        WA2dt.Mem(ReO).EN.Support.SS = True Then
                        SupportRevised = New _
                                    Line2DT.Node.SupportCondition(False,
                                                False,
                                                WA2dt.Mem(ReO).EN.Support.PS,
                                                WA2dt.Mem(ReO).EN.Support.PRS,
                                                WA2dt.Mem(ReO).EN.Support.FRS,
                                                WA2dt.Mem(ReO).EN.Support.FS,
                                                WA2dt.Mem(ReO).EN.Support.SS,
                        ...
                        Exit For
                    ElseIf WA2dt.Mem(ReO).EN.Support.PJ = True Or
                            WA2dt.Mem(ReO).EN.Support.RJ = True Then
                        SupportRevised = New _
                                    Line2DT.Node.SupportCondition(
                                                WA2dt.Mem(ReO).EN.Support.PJ,
                                                WA2dt.Mem(ReO).EN.Support.RJ,
                                                False,
                                                False,
                                                False,
                                                False,
        ...
        For Each leftOut In PooF
            If WA2dt.Mem(leftOut).SN.Support.PJ = False And
                WA2dt.Mem(leftOut).SN.Support.RJ = False And
                WA2dt.Mem(leftOut).SN.Support.PS = False And
                WA2dt.Mem(leftOut).SN.Support.PRS = False And
                WA2dt.Mem(leftOut).SN.Support.FRS = False And
                WA2dt.Mem(leftOut).SN.Support.FS = False And
            ...
            ElseIf WA2dt.Mem(leftOut).EN.Support.PJ = False And
                WA2dt.Mem(leftOut).EN.Support.RJ = False And
                WA2dt.Mem(leftOut).EN.Support.PS = False And
                WA2dt.Mem(leftOut).EN.Support.PRS = False And
                WA2dt.Mem(leftOut).EN.Support.FRS = False And
                WA2dt.Mem(leftOut).EN.Support.FS = False And
...
#End Region
    ...
    Private Sub CheckSupport(ByRef ChkFlg As Boolean)
        ...
        If I < 2 Then
            _updateStr = vbNewLine & " Checking Support" &
             " ........................" &
             " Failed" &
                vbNewLine
            ChkFlg = True
    ...
    Private Sub CheckLoad(ByRef ChkFlg As Boolean)
        ...
        If I = 0 Then
            _updateStr = vbNewLine & " Checking Load" &
             " ........................" &
             " Failed" &
                vbNewLine
            ChkFlg = True
