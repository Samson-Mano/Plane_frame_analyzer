    ...
    Private Sub NewToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NewToolStripMenuItem.Click
        Try
            If WA2dt.HistU.Count <> 0 Then
                Dim R As MsgBoxResult = MsgBox("Do You Wanna Save Your Progress ?", MsgBoxStyle.YesNoCancel, "FrameANS")
                If R = MsgBoxResult.Yes Then
                    Dim SW As New SaveFileDialog
                    SW.DefaultExt = ".2df"
                    SW.Filter = "Samson Mano's 2D - Object Files (*.2df)|*.2df"
...
#Region "Open "
    ...
    Private Sub OpeningExisting()
        ...
        OW.DefaultExt = ".2df"
        OW.Filter = "Samson Mano's 2D - Object Files (*.2df)|*.2df"
        OW.ShowDialog()
        If File.Exists(OW.FileName) Then
            ...
            _Napplication.defaultRJ = instance6
            ...
            _Napplication.defaultI = instance9
            Dim instance10 As Double = trobject(9)
            _Napplication.defaultScaleFactor = instance10
...
#Region "Save"
    Private Sub SaveToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SaveToolStripMenuItem.Click
        ...
        If SW.FileName <> "" Then
            ...
            trobject.Add(_Napplication.defaultRJ)
            trobject.Add(_Napplication.defaultE)
            trobject.Add(_Napplication.defaultA)
            trobject.Add(_Napplication.defaultI)
...
#Region "Tool Bar controls"
    Private Sub ToolStateChange()
        ...
        ElseIf _arc.Checked = True Then
            _HelpStatusLabel.Text = "Click and Drag to Locate BaseLengh and Click again to Locate the Rise, Input Box will appear asking for number of segments"
        ...
        ElseIf _selectM.Checked = True Then
            If _move.Checked = True Then
                _HelpStatusLabel.Text = "Click to Locate Start Point and Click again to Locate End Point for Cut - Paste"
            ElseIf _clone.Checked = True Then
                _HelpStatusLabel.Text = "Click to Locate Start Point and Click again to Locate End Point for Copy - Paste"
            ElseIf _mirror.Checked = True Then
                _HelpStatusLabel.Text = "Click - Click for Horizontal or Vertical flip"
            End If
        ElseIf _analyze.Checked = True Then
            _HelpStatusLabel.Text = "Click on the member to view the specific member's result"
        Else
...
#Region "Zone 3"
    Private Sub _Memberproperties_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles _memberproperties.Click, MemberpropertiesToolStripMenuItem.Click
        Try
            ...
            End If
        Catch ex As Exception
            MsgBox("Member Properties Window Dialog Error", MsgBoxStyle.Critical, "FrameANS")
        End Try
    ...
    Private Sub _AddLoad_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles _AddLoad.Click, AddloadToolStripMenuItem.Click
        Try
            ...
            End If
        Catch ex As Exception
            MsgBox("AddLoad Window Dialog Error", MsgBoxStyle.Critical, "FrameANS")
        End Try
    ...
    Private Sub _Addsupport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles _Addsupport.Click, AddsupportToolStripMenuItem.Click
        Try
            ...
            End If
        Catch ex As Exception
            MsgBox("Support - Boundary Condition Window Dialog Error", MsgBoxStyle.Critical, "FrameANS")
        End Try
    End Sub
#End Region
...
#Region "Zone 4"
    ...
    Private Sub _shearforce_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles _shearforce.Click, ShearForceToolStripMenuItem.Click
        If _shearforce.Checked = False Then
            _shearforce.Checked = True
            _bendingmoment.Checked = False
            _deflection.Checked = False
            _reaction.Checked = False

            ShearForceToolStripMenuItem.Checked = True
            BendingMomentToolStripMenuItem.Checked = False
            ReactionToolStripMenuItem.Checked = False
            DeflectionToolStripMenuItem.Checked = False
            _Cursorimg = My.Resources.shearforce
            RA2dt.MainPic.Refresh()
        End If
    End Sub

    Private Sub _bendingmoment_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles _bendingmoment.Click, BendingMomentToolStripMenuItem.Click
        If _bendingmoment.Checked = False Then
            _shearforce.Checked = False
            _bendingmoment.Checked = True
            _deflection.Checked = False
            _reaction.Checked = False

            ShearForceToolStripMenuItem.Checked = False
            BendingMomentToolStripMenuItem.Checked = True
            ReactionToolStripMenuItem.Checked = False
            DeflectionToolStripMenuItem.Checked = False
            _Cursorimg = My.Resources.BendingMoment
            RA2dt.MainPic.Refresh()
        End If
    End Sub

    Private Sub _deflection_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles _deflection.Click, DeflectionToolStripMenuItem.Click
        If _deflection.Checked = False Then
            _shearforce.Checked = False
            _bendingmoment.Checked = False
            _deflection.Checked = True
            _reaction.Checked = False
            ...
            _Cursorimg = My.Resources.Deflection
            RA2dt.MainPic.Refresh()
        End If
    End Sub

    Private Sub _reaction_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles _reaction.Click, ReactionToolStripMenuItem.Click
        If _reaction.Checked = False Then
            _shearforce.Checked = False
            _bendingmoment.Checked = False
            _deflection.Checked = False
            _reaction.Checked = True

            ShearForceToolStripMenuItem.Checked = False
            BendingMomentToolStripMenuItem.Checked = False
            ReactionToolStripMenuItem.Checked = True
            DeflectionToolStripMenuItem.Checked = False
            _Cursorimg = My.Resources.reaction
            RA2dt.MainPic.Refresh()
        End If
    End Sub
...
#End Region
    ...
    Private Sub MDIMain_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        _AddLoad.Enabled = False
        _Addsupport.Enabled = False
        _shearforce.Enabled = False
        _bendingmoment.Enabled = False
        _deflection.Enabled = False
