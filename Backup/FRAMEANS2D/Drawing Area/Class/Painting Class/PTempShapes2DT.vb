...
#Region "Pan Draw"
    ...
    Private Sub PaintPanAxis(ByRef e As System.Windows.Forms.PaintEventArgs, ByRef Extent As Point)
        'e.Graphics.DrawLine(New Pen(Color.FromArgb(100, Color.Red), 1 / WA2dt.Zm), Extent.X, -(WA2dt.MainPic.Height / WA2dt.Zm), Extent.X, (WA2dt.MainPic.Height / WA2dt.Zm))
        'e.Graphics.DrawLine(New Pen(Color.FromArgb(100, Color.Blue), 1 / WA2dt.Zm), -(WA2dt.MainPic.Width / WA2dt.Zm), Extent.Y, (WA2dt.MainPic.Width / WA2dt.Zm), Extent.Y)
    End Sub
    ...
    Private Sub PaintPanLoad(ByRef e As System.Windows.Forms.PaintEventArgs, ByRef Extent As Point)
        For Each El In WA2dt.Mem
            For Each itm In El.Pload
                ...
                e.Graphics.DrawLine(loadpen, itm.PCoordS.X + Extent.X, itm.PCoordS.Y + Extent.Y, itm.PCoordE.X + Extent.X, itm.PCoordE.Y + Extent.Y)
                If MDIMain.LoadviewoptionToolStripMenuItem.Checked = True Then
                    e.Graphics.DrawString(Math.Abs(itm.pload), New Font("Verdana", (8 / WA2dt.Zm)), New Pen(Color.Green, 2 / WA2dt.Zm).Brush, itm.PCoordE.X + Extent.X + (2 / WA2dt.Zm), itm.PCoordE.Y + Extent.Y + (2 / WA2dt.Zm))
                End If
            Next
            For Each itm In El.Uload
                ...
                Dim uStream() As Point = { _
                                            New Point(itm.uCoordS1.X + Extent.X, itm.uCoordS1.Y + Extent.Y), _
                                            New Point(itm.uCoordE1.X + Extent.X, itm.uCoordE1.Y + Extent.Y), _
                                            New Point(itm.uCoordE2.X + Extent.X, itm.uCoordE2.Y + Extent.Y), _
                                            New Point(itm.uCoordS2.X + Extent.X, itm.uCoordS2.Y + Extent.Y), _
                                            New Point(itm.uCoordS1.X + Extent.X, itm.uCoordS1.Y + Extent.Y)}
                Dim Stream_path As New GraphicsPath
                Stream_path.AddClosedCurve(uStream, 0)
                e.Graphics.FillPath(hBrush3, Stream_path)


                Dim loadpen As New System.Drawing.Pen(Color.DeepPink, 2 / WA2dt.Zm)
                loadpen.CustomStartCap = New System.Drawing.Drawing2D.AdjustableArrowCap(3, 5)
                e.Graphics.DrawLine(loadpen, itm.uCoordS1.X + Extent.X, itm.uCoordS1.Y + Extent.Y, itm.uCoordE1.X + Extent.X, itm.uCoordE1.Y + Extent.Y)
                e.Graphics.DrawLine(loadpen, itm.uCoordS2.X + Extent.X, itm.uCoordS2.Y + Extent.Y, itm.uCoordE2.X + Extent.X, itm.uCoordE2.Y + Extent.Y)
                e.Graphics.DrawLine(New Pen(Color.DeepPink, (2 / WA2dt.Zm)), itm.uCoordE1.X + Extent.X, itm.uCoordE1.Y + Extent.Y, itm.uCoordE2.X + Extent.X, itm.uCoordE2.Y + Extent.Y)
                If MDIMain.LoadviewoptionToolStripMenuItem.Checked = True Then
                    e.Graphics.DrawString(Math.Abs(itm.uload1), New Font("Verdana", (8 / WA2dt.Zm)), New Pen(Color.DeepPink, 2 / WA2dt.Zm).Brush, itm.uCoordE1.X + Extent.X + (2 / WA2dt.Zm), itm.uCoordE1.Y + Extent.Y + (2 / WA2dt.Zm))
                    e.Graphics.DrawString(Math.Abs(itm.uload2), New Font("Verdana", (8 / WA2dt.Zm)), New Pen(Color.DeepPink, 2 / WA2dt.Zm).Brush, itm.uCoordE2.X + Extent.X + (2 / WA2dt.Zm), itm.uCoordE2.Y + Extent.Y + (2 / WA2dt.Zm))
                End If
            Next
            For Each itm In El.Mload
                Dim loadpen As New System.Drawing.Pen(Color.Orange, 2 / WA2dt.Zm)
                ...
                e.Graphics.DrawArc(loadpen, itm.mCoord.X + Extent.X - 30, itm.mCoord.Y + Extent.Y - 30, 60, 60, 360, 270)
                If MDIMain.LoadviewoptionToolStripMenuItem.Checked = True Then
                    e.Graphics.DrawString(Math.Abs(itm.mload), New Font("Verdana", (8 / WA2dt.Zm)), New Pen(Color.Orange, 2 / WA2dt.Zm).Brush, itm.mCoord.X + Extent.X - 30, itm.mCoord.Y + Extent.Y + 30)
                End If
            Next
        Next
    End Sub
    ...
    Private Sub PaintPanSupport(ByRef e As System.Windows.Forms.PaintEventArgs, ByRef Extent As Point)
        ...
        For Each EL In WA2dt.Mem
            ...
            ElseIf EL.SN.Support.RJ = True Then
                SupportPicPaintRigidJoint(e, New Point(EL.SN.Coord.X + Extent.X, EL.SN.Coord.Y + Extent.Y))
            ...
            ElseIf EL.SN.Support.PRS = True Then
                SupportPicPaintPinRollerSupport(e, New Point(EL.SN.Coord.X + Extent.X, EL.SN.Coord.Y + Extent.Y), EL.SN.Support.supportinclination, 0.5 / WA2dt.Zm)
            ElseIf EL.SN.Support.FRS = True Then
                SupportPicPaintFixedRollerSupport(e, New Point(EL.SN.Coord.X + Extent.X, EL.SN.Coord.Y + Extent.Y), EL.SN.Support.supportinclination, 0.5 / WA2dt.Zm)
            ElseIf EL.SN.Support.FS = True Then
                SupportPicPaintFixedSupport(e, New Point(EL.SN.Coord.X + Extent.X, EL.SN.Coord.Y + Extent.Y), EL.SN.Support.supportinclination, 0.5 / WA2dt.Zm)
            ElseIf EL.SN.Support.SS = True Then
                SupportPicPaintSpringSupport(e, New Point(EL.SN.Coord.X + Extent.X, EL.SN.Coord.Y + Extent.Y), EL.SN.Support.supportinclination, 0.5 / WA2dt.Zm)
            End If
            ...
            ElseIf EL.EN.Support.RJ = True Then
                SupportPicPaintRigidJoint(e, New Point(EL.EN.Coord.X + Extent.X, EL.EN.Coord.Y + Extent.Y))
            ...
            ElseIf EL.EN.Support.PRS = True Then
                SupportPicPaintPinRollerSupport(e, New Point(EL.EN.Coord.X + Extent.X, EL.EN.Coord.Y + Extent.Y), EL.EN.Support.supportinclination, 0.5 / WA2dt.Zm)
            ElseIf EL.EN.Support.FRS = True Then
                SupportPicPaintFixedRollerSupport(e, New Point(EL.EN.Coord.X + Extent.X, EL.EN.Coord.Y + Extent.Y), EL.EN.Support.supportinclination, 0.5 / WA2dt.Zm)
            ElseIf EL.EN.Support.FS = True Then
                SupportPicPaintFixedSupport(e, New Point(EL.EN.Coord.X + Extent.X, EL.EN.Coord.Y + Extent.Y), EL.EN.Support.supportinclination, 0.5 / WA2dt.Zm)
            ElseIf EL.EN.Support.SS = True Then
                SupportPicPaintSpringSupport(e, New Point(EL.EN.Coord.X + Extent.X, EL.EN.Coord.Y + Extent.Y), EL.EN.Support.supportinclination, 0.5 / WA2dt.Zm)
            End If
        Next
    End Sub
#End Region
...
#Region "Move N Clone Draw"
    ...
    Private Sub PaintMCLoad(ByRef e As System.Windows.Forms.PaintEventArgs, ByRef Extent As Point)
        For Each ind In WA2dt.selLine
            For Each itm In WA2dt.Mem(ind).Pload
                Dim loadpen As New System.Drawing.Pen(Color.Green, 2 / WA2dt.Zm)
                loadpen.CustomStartCap = New System.Drawing.Drawing2D.AdjustableArrowCap(3, 5)
                e.Graphics.DrawLine(loadpen, itm.PCoordS.X + Extent.X, itm.PCoordS.Y + Extent.Y, itm.PCoordE.X + Extent.X, itm.PCoordE.Y + Extent.Y)
                If MDIMain.LoadviewoptionToolStripMenuItem.Checked = True Then
                ...
                End If
            Next
            For Each itm In WA2dt.Mem(ind).Uload
                Dim hBrush3 As HatchBrush = New HatchBrush(HatchStyle.DiagonalBrick, Color.DeepPink, Color.Transparent)
                Dim uStream() As Point = { _
                                            New Point(itm.uCoordS1.X + Extent.X, itm.uCoordS1.Y + Extent.Y), _
                                            New Point(itm.uCoordE1.X + Extent.X, itm.uCoordE1.Y + Extent.Y), _
                ...
                End If
            Next
            For Each itm In WA2dt.Mem(ind).Mload
                Dim loadpen As New System.Drawing.Pen(Color.Orange, 2 / WA2dt.Zm)
                loadpen.CustomStartCap = If(itm.mAnticlockwise = True, New System.Drawing.Drawing2D.AdjustableArrowCap(3, 5), New System.Drawing.Drawing2D.AdjustableArrowCap(0, 0))
                loadpen.CustomEndCap = If(itm.mClockwise = True, New System.Drawing.Drawing2D.AdjustableArrowCap(3, 5), New System.Drawing.Drawing2D.AdjustableArrowCap(0, 0))
                e.Graphics.DrawArc(loadpen, itm.mCoord.X + Extent.X - 30, itm.mCoord.Y + Extent.Y - 30, 60, 60, 360, 270)
    ...
    Private Sub PaintMCSupport(ByRef e As System.Windows.Forms.PaintEventArgs, ByRef Extent As Point)
        ...
        For Each ind In WA2dt.selLine
            ...
            ElseIf WA2dt.Mem(ind).SN.Support.RJ = True Then
                SupportPicPaintRigidJoint(e, New Point(WA2dt.Mem(ind).SN.Coord.X + Extent.X, WA2dt.Mem(ind).SN.Coord.Y + Extent.Y))
            ...
            ElseIf WA2dt.Mem(ind).SN.Support.PRS = True Then
                SupportPicPaintPinRollerSupport(e, New Point(WA2dt.Mem(ind).SN.Coord.X + Extent.X, WA2dt.Mem(ind).SN.Coord.Y + Extent.Y), WA2dt.Mem(ind).SN.Support.supportinclination, 0.5)
            ElseIf WA2dt.Mem(ind).SN.Support.FRS = True Then
                SupportPicPaintFixedRollerSupport(e, New Point(WA2dt.Mem(ind).SN.Coord.X + Extent.X, WA2dt.Mem(ind).SN.Coord.Y + Extent.Y), WA2dt.Mem(ind).SN.Support.supportinclination, 0.5)
            ElseIf WA2dt.Mem(ind).SN.Support.FS = True Then
                SupportPicPaintFixedSupport(e, New Point(WA2dt.Mem(ind).SN.Coord.X + Extent.X, WA2dt.Mem(ind).SN.Coord.Y + Extent.Y), WA2dt.Mem(ind).SN.Support.supportinclination, 0.5)
            ElseIf WA2dt.Mem(ind).SN.Support.SS = True Then
                SupportPicPaintSpringSupport(e, New Point(WA2dt.Mem(ind).SN.Coord.X + Extent.X, WA2dt.Mem(ind).SN.Coord.Y + Extent.Y), WA2dt.Mem(ind).SN.Support.supportinclination, 0.5)
            End If
            ...
            ElseIf WA2dt.Mem(ind).EN.Support.RJ = True Then
                SupportPicPaintRigidJoint(e, New Point(WA2dt.Mem(ind).EN.Coord.X + Extent.X, WA2dt.Mem(ind).EN.Coord.Y + Extent.Y))
            ...
            ElseIf WA2dt.Mem(ind).EN.Support.PRS = True Then
                SupportPicPaintPinRollerSupport(e, New Point(WA2dt.Mem(ind).EN.Coord.X + Extent.X, WA2dt.Mem(ind).EN.Coord.Y + Extent.Y), WA2dt.Mem(ind).EN.Support.supportinclination, 0.5)
            ElseIf WA2dt.Mem(ind).EN.Support.FRS = True Then
                SupportPicPaintFixedRollerSupport(e, New Point(WA2dt.Mem(ind).EN.Coord.X + Extent.X, WA2dt.Mem(ind).EN.Coord.Y + Extent.Y), WA2dt.Mem(ind).EN.Support.supportinclination, 0.5)
            ElseIf WA2dt.Mem(ind).EN.Support.FS = True Then
                SupportPicPaintFixedSupport(e, New Point(WA2dt.Mem(ind).EN.Coord.X + Extent.X, WA2dt.Mem(ind).EN.Coord.Y + Extent.Y), WA2dt.Mem(ind).EN.Support.supportinclination, 0.5)
            ElseIf WA2dt.Mem(ind).EN.Support.SS = True Then
                SupportPicPaintSpringSupport(e, New Point(WA2dt.Mem(ind).EN.Coord.X + Extent.X, WA2dt.Mem(ind).EN.Coord.Y + Extent.Y), WA2dt.Mem(ind).EN.Support.supportinclination, 0.5)
            End If
        Next
    End Sub
#End Region
...
#Region "Support Pic Paint Events"
    ...
    Private Sub SupportPicPaintRigidJoint(ByRef e As System.Windows.Forms.PaintEventArgs, ByVal M As Point)
        e.Graphics.DrawRectangle(New Pen(OptionD.Nc, 2 / WA2dt.Zm), CInt(M.X - (2 / WA2dt.Zm)), CInt(M.Y - (2 / WA2dt.Zm)), CInt(4 / WA2dt.Zm), CInt(4 / WA2dt.Zm))
        'e.Graphics.FillRectangle(New Pen(OptionD.Nc, 4 / WA2dt.Zm).Brush, M.X - (3 / WA2dt.Zm), M.Y - (3 / WA2dt.Zm), (6 / WA2dt.Zm), (6 / WA2dt.Zm))
    End Sub
    ...
    Private Sub SupportPicPaintFixedRollerSupport(ByRef e As System.Windows.Forms.PaintEventArgs, ByVal M As Point, ByVal Inclination As Double, ByVal ZM As Double)
        '---- Rectangle
        e.Graphics.DrawLine(New Pen(OptionD.Nc, 2 / WA2dt.Zm), New Point(M.X + (((0 * Math.Cos(-Inclination)) + (15 * Math.Sin(-Inclination))) * ZM), M.Y + (((0 * -Math.Sin(-Inclination)) + (15 * Math.Cos(-Inclination))) * ZM)), New Point(M.X + (((0 * Math.Cos(-Inclination)) + (-15 * Math.Sin(-Inclination))) * ZM), M.Y + (((0 * -Math.Sin(-Inclination)) + (-15 * Math.Cos(-Inclination))) * ZM)))
        e.Graphics.DrawLine(New Pen(OptionD.Nc, 2 / WA2dt.Zm), New Point(M.X + (((0 * Math.Cos(-Inclination)) + (15 * Math.Sin(-Inclination))) * ZM), M.Y + (((0 * -Math.Sin(-Inclination)) + (15 * Math.Cos(-Inclination))) * ZM)), New Point(M.X + (((20 * Math.Cos(-Inclination)) + (15 * Math.Sin(-Inclination))) * ZM), M.Y + (((20 * -Math.Sin(-Inclination)) + (15 * Math.Cos(-Inclination))) * ZM)))
        e.Graphics.DrawLine(New Pen(OptionD.Nc, 2 / WA2dt.Zm), New Point(M.X + (((20 * Math.Cos(-Inclination)) + (15 * Math.Sin(-Inclination))) * ZM), M.Y + (((20 * -Math.Sin(-Inclination)) + (15 * Math.Cos(-Inclination))) * ZM)), New Point(M.X + (((20 * Math.Cos(-Inclination)) + (-15 * Math.Sin(-Inclination))) * ZM), M.Y + (((20 * -Math.Sin(-Inclination)) + (-15 * Math.Cos(-Inclination))) * ZM)))
        e.Graphics.DrawLine(New Pen(OptionD.Nc, 2 / WA2dt.Zm), New Point(M.X + (((0 * Math.Cos(-Inclination)) + (-15 * Math.Sin(-Inclination))) * ZM), M.Y + (((0 * -Math.Sin(-Inclination)) + (-15 * Math.Cos(-Inclination))) * ZM)), New Point(M.X + (((20 * Math.Cos(-Inclination)) + (-15 * Math.Sin(-Inclination))) * ZM), M.Y + (((20 * -Math.Sin(-Inclination)) + (-15 * Math.Cos(-Inclination))) * ZM)))
    ...
    Private Sub SupportPicPaintFixedSupport(ByRef e As System.Windows.Forms.PaintEventArgs, ByVal M As Point, ByVal Inclination As Double, ByVal ZM As Double)
        '---- Rectangle
        e.Graphics.DrawLine(New Pen(OptionD.Nc, 2 / WA2dt.Zm), New Point(M.X + (((0 * Math.Cos(-Inclination)) + (25 * Math.Sin(-Inclination))) * ZM), M.Y + (((0 * -Math.Sin(-Inclination)) + (25 * Math.Cos(-Inclination))) * ZM)), New Point(M.X + (((0 * Math.Cos(-Inclination)) + (-25 * Math.Sin(-Inclination))) * ZM), M.Y + (((0 * -Math.Sin(-Inclination)) + (-25 * Math.Cos(-Inclination))) * ZM)))
        e.Graphics.DrawLine(New Pen(OptionD.Nc, 2 / WA2dt.Zm), New Point(M.X + (((0 * Math.Cos(-Inclination)) + (25 * Math.Sin(-Inclination))) * ZM), M.Y + (((0 * -Math.Sin(-Inclination)) + (25 * Math.Cos(-Inclination))) * ZM)), New Point(M.X + (((20 * Math.Cos(-Inclination)) + (25 * Math.Sin(-Inclination))) * ZM), M.Y + (((20 * -Math.Sin(-Inclination)) + (25 * Math.Cos(-Inclination))) * ZM)))
        e.Graphics.DrawLine(New Pen(OptionD.Nc, 2 / WA2dt.Zm), New Point(M.X + (((20 * Math.Cos(-Inclination)) + (25 * Math.Sin(-Inclination))) * ZM), M.Y + (((20 * -Math.Sin(-Inclination)) + (25 * Math.Cos(-Inclination))) * ZM)), New Point(M.X + (((20 * Math.Cos(-Inclination)) + (-25 * Math.Sin(-Inclination))) * ZM), M.Y + (((20 * -Math.Sin(-Inclination)) + (-25 * Math.Cos(-Inclination))) * ZM)))
        e.Graphics.DrawLine(New Pen(OptionD.Nc, 2 / WA2dt.Zm), New Point(M.X + (((0 * Math.Cos(-Inclination)) + (-25 * Math.Sin(-Inclination))) * ZM), M.Y + (((0 * -Math.Sin(-Inclination)) + (-25 * Math.Cos(-Inclination))) * ZM)), New Point(M.X + (((20 * Math.Cos(-Inclination)) + (-25 * Math.Sin(-Inclination))) * ZM), M.Y + (((20 * -Math.Sin(-Inclination)) + (-25 * Math.Cos(-Inclination))) * ZM)))
    ...
    Private Sub SupportPicPaintSpringSupport(ByRef e As System.Windows.Forms.PaintEventArgs, ByVal M As Point, ByVal Inclination As Double, ByVal ZM As Double)
        '----SPRING
        e.Graphics.DrawLine(New Pen(OptionD.Nc, 2 / WA2dt.Zm), New Point(M.X + (((Math.Cos(-Inclination)) + (Math.Sin(-Inclination))) * ZM), M.Y + (((-Math.Sin(-Inclination)) + (Math.Cos(-Inclination))) * ZM)), New Point(M.X + (((4 * Math.Cos(-Inclination)) + (Math.Sin(-Inclination))) * ZM), M.Y + (((4 * -Math.Sin(-Inclination)) + (Math.Cos(-Inclination))) * ZM)))
        e.Graphics.DrawLine(New Pen(OptionD.Nc, 2 / WA2dt.Zm), New Point(M.X + (((4 * Math.Cos(-Inclination)) + (-12 * Math.Sin(-Inclination))) * ZM), M.Y + (((4 * -Math.Sin(-Inclination)) + (-12 * Math.Cos(-Inclination))) * ZM)), New Point(M.X + (((4 * Math.Cos(-Inclination)) + (12 * Math.Sin(-Inclination))) * ZM), M.Y + (((4 * -Math.Sin(-Inclination) + (12 * Math.Cos(-Inclination)))) * ZM)))
        e.Graphics.DrawLine(New Pen(OptionD.Nc, 2 / WA2dt.Zm), New Point(M.X + (((10 * Math.Cos(-Inclination)) + (-12 * Math.Sin(-Inclination))) * ZM), M.Y + (((10 * -Math.Sin(-Inclination)) + (-12 * Math.Cos(-Inclination))) * ZM)), New Point(M.X + (((10 * Math.Cos(-Inclination)) + (12 * Math.Sin(-Inclination))) * ZM), M.Y + (((10 * -Math.Sin(-Inclination) + (12 * Math.Cos(-Inclination)))) * ZM)))
        ...
        e.Graphics.DrawLine(New Pen(OptionD.Nc, 2 / WA2dt.Zm), New Point(M.X + (((16 * Math.Cos(-Inclination)) + (-12 * Math.Sin(-Inclination))) * ZM), M.Y + (((16 * -Math.Sin(-Inclination)) + (-12 * Math.Cos(-Inclination))) * ZM)), New Point(M.X + (((16 * Math.Cos(-Inclination)) + (12 * Math.Sin(-Inclination))) * ZM), M.Y + (((16 * -Math.Sin(-Inclination) + (12 * Math.Cos(-Inclination)))) * ZM)))
        e.Graphics.DrawLine(New Pen(OptionD.Nc, 2 / WA2dt.Zm), New Point(M.X + (((16 * Math.Cos(-Inclination)) + (Math.Sin(-Inclination))) * ZM), M.Y + (((16 * -Math.Sin(-Inclination)) + (Math.Cos(-Inclination))) * ZM)), New Point(M.X + (((20 * Math.Cos(-Inclination)) + (Math.Sin(-Inclination))) * ZM), M.Y + (((-20 * Math.Sin(-Inclination)) + (Math.Cos(-Inclination))) * ZM)))
...
#Region "Mirror Draw"
    ...
    Private Sub PaintHorizFlip(ByRef e As System.Windows.Forms.PaintEventArgs, ByRef Mirx As Double)
        ...
        PaintMirrLoad(e, New Point((2 * Mirx), 0), -1, 1)
    End Sub
    ...
    Private Sub PaintVertFlip(ByRef e As System.Windows.Forms.PaintEventArgs, ByRef Miry As Double)
        ...
        PaintMirrLoad(e, New Point(0, (2 * Miry)), 1, -1)
    End Sub
    ...
    Private Sub PaintMirrSupport(ByRef e As System.Windows.Forms.PaintEventArgs, ByRef MirrX As Double, ByVal XF As Integer, ByRef MirrY As Double, ByVal YF As Integer)
        ...
        For Each ind In WA2dt.selLine
            ...
            ElseIf WA2dt.Mem(ind).SN.Support.RJ = True Then
                SupportPicPaintRigidJoint(e, New Point(FlipPt1.X, FlipPt1.Y))
            ElseIf WA2dt.Mem(ind).SN.Support.PS = True Then
                SupportPicPaintPinSupport(e, New Point(FlipPt1.X, FlipPt1.Y), WA2dt.Mem(ind).SN.Support.supportinclination, 0.5)
            ElseIf WA2dt.Mem(ind).SN.Support.PRS = True Then
                SupportPicPaintPinRollerSupport(e, New Point(FlipPt1.X, FlipPt1.Y), WA2dt.Mem(ind).SN.Support.supportinclination, 0.5)
            ElseIf WA2dt.Mem(ind).SN.Support.FRS = True Then
                SupportPicPaintFixedRollerSupport(e, New Point(FlipPt1.X, FlipPt1.Y), WA2dt.Mem(ind).SN.Support.supportinclination, 0.5)
            ElseIf WA2dt.Mem(ind).SN.Support.FS = True Then
                SupportPicPaintFixedSupport(e, New Point(FlipPt1.X, FlipPt1.Y), WA2dt.Mem(ind).SN.Support.supportinclination, 0.5)
            ElseIf WA2dt.Mem(ind).SN.Support.SS = True Then
                SupportPicPaintSpringSupport(e, New Point(FlipPt1.X, FlipPt1.Y), WA2dt.Mem(ind).SN.Support.supportinclination, 0.5)
            End If
            ...
            ElseIf WA2dt.Mem(ind).EN.Support.RJ = True Then
                SupportPicPaintRigidJoint(e, New Point(FlipPt2.X, FlipPt2.Y))
            ElseIf WA2dt.Mem(ind).EN.Support.PS = True Then
                SupportPicPaintPinSupport(e, New Point(FlipPt2.X, FlipPt2.Y), WA2dt.Mem(ind).EN.Support.supportinclination, 0.5)
            ElseIf WA2dt.Mem(ind).EN.Support.PRS = True Then
                SupportPicPaintPinRollerSupport(e, New Point(FlipPt2.X, FlipPt2.Y), WA2dt.Mem(ind).EN.Support.supportinclination, 0.5)
            ElseIf WA2dt.Mem(ind).EN.Support.FRS = True Then
                SupportPicPaintFixedRollerSupport(e, New Point(FlipPt2.X, FlipPt2.Y), WA2dt.Mem(ind).EN.Support.supportinclination, 0.5)
            ElseIf WA2dt.Mem(ind).EN.Support.FS = True Then
                SupportPicPaintFixedSupport(e, New Point(FlipPt2.X, FlipPt2.Y), WA2dt.Mem(ind).EN.Support.supportinclination, 0.5)
            ElseIf WA2dt.Mem(ind).EN.Support.SS = True Then
                SupportPicPaintSpringSupport(e, New Point(FlipPt2.X, FlipPt2.Y), WA2dt.Mem(ind).EN.Support.supportinclination, 0.5)
            End If
        Next
    End Sub

    Private Sub PaintMirrLoad(ByRef e As System.Windows.Forms.PaintEventArgs, ByRef Extent As Point, ByRef XF As Integer, ByRef YF As Integer)
        For Each ind In WA2dt.selLine
            For Each itm In WA2dt.Mem(ind).Pload
                Dim loadpen As New System.Drawing.Pen(Color.Green, 2 / WA2dt.Zm)
                loadpen.CustomStartCap = New System.Drawing.Drawing2D.AdjustableArrowCap(3, 5)
                e.Graphics.DrawLine(loadpen, XF * (itm.PCoordS.X) + Extent.X, YF * (itm.PCoordS.Y) + Extent.Y, XF * (itm.PCoordE.X) + Extent.X, YF * (itm.PCoordE.Y) + Extent.Y)
                If MDIMain.LoadviewoptionToolStripMenuItem.Checked = True Then
                    e.Graphics.DrawString(Math.Abs(itm.pload), New Font("Verdana", (8 / WA2dt.Zm)), New Pen(Color.Green, 2 / WA2dt.Zm).Brush, XF * (itm.PCoordE.X) + Extent.X + (2 / WA2dt.Zm), YF * (itm.PCoordE.Y) + Extent.Y + (2 / WA2dt.Zm))
                End If
            Next
            For Each itm In WA2dt.Mem(ind).Uload
                Dim hBrush3 As HatchBrush = New HatchBrush(HatchStyle.DiagonalBrick, Color.DeepPink, Color.Transparent)
                Dim uStream() As Point = { _
                                            New Point(XF * (itm.uCoordS1.X) + Extent.X, YF * (itm.uCoordS1.Y) + Extent.Y), _
                                            New Point(XF * (itm.uCoordE1.X) + Extent.X, YF * (itm.uCoordE1.Y) + Extent.Y), _
                                            New Point(XF * (itm.uCoordE2.X) + Extent.X, YF * (itm.uCoordE2.Y) + Extent.Y), _
                                            New Point(XF * (itm.uCoordS2.X) + Extent.X, YF * (itm.uCoordS2.Y) + Extent.Y), _
                                            New Point(XF * (itm.uCoordS1.X) + Extent.X, YF * (itm.uCoordS1.Y) + Extent.Y)}
                Dim Stream_path As New GraphicsPath
                Stream_path.AddClosedCurve(uStream, 0)
                e.Graphics.FillPath(hBrush3, Stream_path)
                ...
                Dim loadpen As New System.Drawing.Pen(Color.DeepPink, 2 / WA2dt.Zm)
                loadpen.CustomStartCap = New System.Drawing.Drawing2D.AdjustableArrowCap(3, 5)
                e.Graphics.DrawLine(loadpen, XF * (itm.uCoordS1.X) + Extent.X, YF * (itm.uCoordS1.Y) + Extent.Y, XF * (itm.uCoordE1.X) + Extent.X, YF * (itm.uCoordE1.Y) + Extent.Y)
                e.Graphics.DrawLine(loadpen, XF * (itm.uCoordS2.X) + Extent.X, YF * (itm.uCoordS2.Y) + Extent.Y, XF * (itm.uCoordE2.X) + Extent.X, YF * (itm.uCoordE2.Y) + Extent.Y)
                e.Graphics.DrawLine(New Pen(Color.DeepPink, (2 / WA2dt.Zm)), XF * (itm.uCoordE1.X) + Extent.X, YF * (itm.uCoordE1.Y) + Extent.Y, XF * (itm.uCoordE2.X) + Extent.X, YF * (itm.uCoordE2.Y) + Extent.Y)
                If MDIMain.LoadviewoptionToolStripMenuItem.Checked = True Then
                    e.Graphics.DrawString(Math.Abs(itm.uload1), New Font("Verdana", (8 / WA2dt.Zm)), New Pen(Color.DeepPink, 2 / WA2dt.Zm).Brush, XF * (itm.uCoordE1.X) + Extent.X + (2 / WA2dt.Zm), YF * (itm.uCoordE1.Y) + Extent.Y + (2 / WA2dt.Zm))
                    e.Graphics.DrawString(Math.Abs(itm.uload2), New Font("Verdana", (8 / WA2dt.Zm)), New Pen(Color.DeepPink, 2 / WA2dt.Zm).Brush, XF * (itm.uCoordE2.X) + Extent.X + (2 / WA2dt.Zm), YF * (itm.uCoordE2.Y) + Extent.Y + (2 / WA2dt.Zm))
                End If
            Next
            For Each itm In WA2dt.Mem(ind).Mload
                Dim loadpen As New System.Drawing.Pen(Color.Orange, 2 / WA2dt.Zm)
                loadpen.CustomStartCap = If(itm.mAnticlockwise = True, New System.Drawing.Drawing2D.AdjustableArrowCap(3, 5), New System.Drawing.Drawing2D.AdjustableArrowCap(0, 0))
                loadpen.CustomEndCap = If(itm.mClockwise = True, New System.Drawing.Drawing2D.AdjustableArrowCap(3, 5), New System.Drawing.Drawing2D.AdjustableArrowCap(0, 0))
                e.Graphics.DrawArc(loadpen, XF * (itm.mCoord.X) + Extent.X - 30, YF * (itm.mCoord.Y) + Extent.Y - 30, 60, 60, 360, 270)
                If MDIMain.LoadviewoptionToolStripMenuItem.Checked = True Then
                    e.Graphics.DrawString(Math.Abs(itm.mload), New Font("Verdana", (8 / WA2dt.Zm)), New Pen(Color.Orange, 2 / WA2dt.Zm).Brush, XF * (itm.mCoord.X) + Extent.X - 30, YF * (itm.mCoord.Y) + Extent.Y + 30)
                End If
            Next
        Next
    End Sub
